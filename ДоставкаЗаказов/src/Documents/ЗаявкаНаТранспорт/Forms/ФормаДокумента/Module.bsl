...
Процедура ТранспортНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	...
	ОбщегоНазначенияКлиент.ОткрытьФормуВыбора(ТранспортСБригадой, "Справочник.ТранспортныеСредства.ФормаВыбора", Элементы.Транспорт, "Наименование")
...
Функция ТранспортСБригадой(Дата)
	...
	ТранспортСБригадой = ОбщегоНазначенияВызовСервера.НоваяСтруктураОтбора(Выборка, Выборка.Транспорт);
