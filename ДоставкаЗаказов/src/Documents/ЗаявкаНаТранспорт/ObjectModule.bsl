...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ТранспортныйОтделВызовСервера.ПроверитьУсловие(Отказ, Условие, "Поле ГрузчикПервый должно быть заполнено");				
	
	Условие = НЕ ЗначениеЗаполнено(ГрузчикВторой);
	ТранспортныйОтделВызовСервера.ПроверитьУсловие(Отказ, Условие, "Поле ГрузчикВторой должно быть заполнено");				
